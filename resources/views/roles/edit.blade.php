...
<div class="card">
    <div class="container-fluid mt-2">
        <form action="{{route('role.update',$role->id)}}" id="sendform" method="POST">
            @csrf
            @method("PATCH")
            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="name" placeholder="បញ្ចូលឈ្មោះតួនាទី" required value="{{$role->name}}">
                        </div>
                    </div>
                </div>
            </div>
